      ...
      <div class="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
        ...
        <div class="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
          ...
          <div class="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
            ...
            <p class="text-sm text-gray-300 mt-4">Have Questions? We’re Here to Help!</p>
              ...
              <div class="grid sm:grid-cols-2 gap-8">
                ...
                <div class="relative flex items-center">
                  <input type="number" placeholder="Phone No."
                    class="px-2 py-3 bg-white text-black w-full text-sm  border-b border-gray-300 focus:border-blue-500 outline-none" />
                ...
                <div class="col-span-full">
                  ...
                  <div class="flex max-lg:flex-col gap-6 mt-4">
                    <div class="flex items-center">
                      ...
                      <p class="text-sm text-gray-500 ml-4">Batsman</p>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <p class="text-sm text-gray-500 ml-4">Bowler</p>
                    </div>
                    ...
                    <div class="flex items-center">
                      ...
                      <p class="text-sm text-gray-500 ml-4">Allrounder</p>
                    </div>

                    <div class="flex items-center">
                      <input id="checkbox1" type="checkbox" name="role" class="hidden peer" />
                      <label for="checkbox1"
                        class="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-none overflow-hidden">
                        <span class="border-[4px] border-[#011c2b] rounded-none w-full h-full"></span>
                      </label>
                      <p class="text-sm text-gray-500 ml-4">Wicket Keeper</p>
                    </div>
