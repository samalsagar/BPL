...
const hanldeSubmit = (e) => {
  e.preventDefault();
  console.log(firstName, lastName, number, email, role, isWicketKeeper ? "Yes" : "No");

  // const emailTest = email.length>0 ? email : "NA"
  // const w = isWicketKeeper ? "Yes" : "No";
  ...
  // console.log(name, patientName, patientage, mobileNumber, area, service);
    const data = {
      ...
      LastName: lastName,
      MobileNumber: number,
      Email:email.length>0 ? email : "NA",
      Role:role,
      WicketKeeper: isWicketKeeper ? "Yes" : "No"
  };

  console.log(data);
  

  axios.post('https://api.sheetbest.com/sheets/333e082b-f71f-4c0d-bca2-45347c7ae436', data).then((response) => {
      // console.log(response);
      Swal.fire('Thanks for Signing Up for BPL!', 'We’re excited to have you! We’ll see you soon on the field.', 'success');
    ...
    <>
      <div className="max-w-5xl max-lg:max-w-3xl mx-auto bg-white my-6 font-[sans-serif]">
        <div className="text-center px-6">
          <h2 className="text-gray-800 text-3xl font-bold">BPL REGISTRATION</h2>
          <p className="text-sm text-gray-500 mt-4">Welcome to the official registration portal htmlFor the Boitalupatna Premier League (BPL). To participate in the exciting cricket tournament, please ensure you complete all required fields in the registration form below. Players must be registered with a valid cricket background and meet the eligibility criteria outlined in the official tournament guidelines.</p>
        </div>
        ...
        <div className="grid lg:grid-cols-3 items-start gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-12">
          ...
          <div className="bg-[#011c2b] rounded-lg p-6 h-full max-lg:order-1">
            ...
            <p className="text-sm text-gray-300 mt-4">Have Questions? We’re Here to Help!</p>
            ...
            <ul className="mt-16 space-y-8">
              <li className="flex items-center">
                ...
                <a className="text-sm text-gray-300 ml-4">
                  sagar30032001@gmail.com
                </a>
              </li>
              <li className="flex items-center">
                ...
                <div className="col-span-full">
                  ...
                  <div className="flex max-lg:flex-col gap-6 mt-4">
                    <div className="flex items-center">
                      ...
                      id="radio1" type="radio" name="value1" className="hidden peer" />
                      <label htmlFor="radio1"
                        ...
                        <span className="border-[4px] border-[#252627] rounded-full w-full h-full"></span>
                      </label>
                      <p className="text-sm text-gray-500 ml-4">Batsman</p>
                    </div>
                    ...
                    <div className="flex items-center">
                      <input 
                       value="Bowler"
                       onChange={(e) => setRole(e.target.value)}
                      id="radio2" type="radio" name="value1" className="hidden peer" />
                      <label htmlFor="radio2"
                        className="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-full overflow-hidden">
                        <span className="border-[4px] border-[#011c2b] rounded-full w-full h-full"></span>
                      </label>
                      <p className="text-sm text-gray-500 ml-4">Bowler</p>
                    </div>
                    ...
                    <div className="flex items-center">
                      ...
                      value="Allrounder"
                      onChange={(e) => setRole(e.target.value)}
                      id="radio3" type="radio" name="value1" className="hidden peer" />
                      <label htmlFor="radio3"
                        className="relative p-0.5 flex items-center justify-center shrink-0 peer-checked:before:hidden before:block before:absolute before:w-full before:h-full before:bg-white w-5 h-5 cursor-pointer border-2 border-[#011c2b] rounded-full overflow-hidden">
                        <span className="border-[4px] border-[#011c2b] rounded-full w-full h-full"></span>
                      </label>
                      <p className="text-sm text-gray-500 ml-4">Allrounder</p>
                    </div>
                  ...
                  className="w-5 h-5 border-2 border-[#011c2b] rounded-full"
                />
                <label htmlFor="isWicketKeeper" className="ml-4 text-sm text-gray-500">
                  Is Wicket Keeper? {isWicketKeeper ? 'Yes' : 'No'}
                </label>
                    </div>
